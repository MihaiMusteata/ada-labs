...
Varianta `openmpi-v2` porneste 2 containere, fiecare cu `slots=16`.

Parametrul `n` reprezinta dificultatea, adica numarul de zerouri cerute la inceputul hash-ului.

## Pregatire

Din folderul `openmpi-v2` ruleaza:
...
- construieste sau actualizeaza cele 2 containere prin Docker Compose
- compileaza aplicatia in container
- regenereaza `available_hosts_file` cu `slots=16`
